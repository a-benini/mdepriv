test_that("mdepriv: argument items", {
  ...
  expect_error(
    mdepriv(simul_data_2, c("y1", "y2", "A")),
  ...
  expect_error(
    mdepriv(simul_data_2, c("y1", "y2", "A", "B")),
