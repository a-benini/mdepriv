test_that("corr_mat: argument items", {
  ...
  expect_error(
    corr_mat(simul_data_2, c("y1", "y2", "A")),
  ...
  expect_error(
    corr_mat(simul_data_2, c("y1", "y2", "A", "B")),
