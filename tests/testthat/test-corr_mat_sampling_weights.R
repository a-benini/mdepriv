test_that("corr_mat: argument sampling_weights", {
  ...
  expect_error(corr_mat(simul_data_2, c("y1", "y2"), "sampl_weights"),
  ...
  expect_error(corr_mat(simul_data, c("y1", "y2"), "y1"),
  ...
  expect_error(corr_mat(simul_data, c("y1", "y2"), c(T, F)),
  ...
  expect_error(corr_mat(simul_data, c("y1", "y2"), c("A", "B")),
  ...
  expect_error(corr_mat(simul_data, c("y1", "y2"), "XXX"),
