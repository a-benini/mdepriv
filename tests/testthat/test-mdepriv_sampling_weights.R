test_that("mdepriv: argument sampling_weights", {
  ...
  expect_error(mdepriv(simul_data_2, c("y1", "y2"), "sampl_weights"),
  ...
  expect_error(mdepriv(simul_data, c("y1", "y2"), "y1"),
  ...
  expect_error(mdepriv(simul_data, c("y1", "y2"), c(T, F)),
  ...
  expect_error(mdepriv(simul_data, c("y1", "y2"), c("A", "B")),
  ...
  expect_error(mdepriv(simul_data, c("y1", "y2"), "XXX"),
