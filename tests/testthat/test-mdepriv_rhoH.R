test_that("mdepriv: argument rhoH", {
  expect_equal(
    mdepriv(simul_data, c("y1", "y2"), method = "bv"),
  ...
  expect_equal(
    mdepriv(simul_data, c("y1", "y2"), method = "bv", rhoH = 0.5, output = "rhoH"),
    0.5
  )

  expect_equal(
    mdepriv(simul_data, c("y1", "y2", "y3", "y4", "y5", "y6", "y7"), method = "bv", output = "rhoH"),
    0.656301573242914
  )
