...
curve(ds, 0.025, 1, xname = "x", col = "magenta", add = T, lwd = 2)
curve(cz, 0.025, 1, xname = "x", col = "chartreuse3", add = T, lwd = 2)
curve(bv, 0.025, 1, xname = "x", col = "orange",  add = T, lwd = 2)
